...
<div id="layoutSidenav_content">
    <div class="container-fluid">
        <h1 class="mt-4">My Booking List</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">My Booking List</li>
        </ol>
                        ...
                        <div class="table-responsive ">
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    ?>
                                    <form action="<?= base_url(); ?>/views/my-booking/<?= $kode_guest; ?>" method="post">
                                    ...
                                    <?php foreach ($booking as $data) : ?>
                                        ...
                                        <tr class="<?= $bg; ?>">
                                            ...
                                            <td class="text-nowrap">
                                                <?= $action; ?>
                                                <?php if ($status_booking == 'Booking') : ?>
                                                    <?php $kodeBooking = base64_encode($data['kode_booking']) ?>
                                                    <a href="<?= base_url(); ?>/views/edit-booking/<?= $kodeBooking; ?>" class="btn btn-sm btn-warning">Edit</a>
                                                    <a href="<?= base_url(); ?>/views/cancel-booking/<?= $kodeBooking; ?>" class="btn btn-sm btn-danger">Cancel</a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
